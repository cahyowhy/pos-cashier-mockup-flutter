...
abstract class _OrderBean implements Bean<Order> {
  ...
  Future<void> createTable({bool ifNotExists = false}) async {
    ...
    st.addInt(serviceCharge.name, isNullable: false);
    st.addInt(promoDiscount.name, isNullable: false);
    st.addInt(salesDiscount.name, isNullable: false);
    st.addInt(shiftId.name, isNullable: false);
    st.addInt(createdId.name, isNullable: false);
    st.addInt(placeId.name, isNullable: false);
    st.addDouble(subTotal.name, isNullable: false);
    st.addDouble(cash.name, isNullable: false);
    st.addDouble(change.name, isNullable: false);
    st.addDouble(ppn.name, isNullable: false);
    st.addDouble(grandTotal.name, isNullable: false);
    st.addInt(transactionTime.name, isNullable: false);
    st.addInt(paymentTypeId.name, isNullable: false);
    st.addStr(paymentTypeJson.name, isNullable: false);
    st.addInt(serviceTypeId.name, isNullable: false);
    st.addStr(serviceTypeJson.name, isNullable: false);
    st.addInt(reservationId.name, isNullable: false);
    st.addStr(reservationName.name, isNullable: false);
    st.addStr(reservationJson.name, isNullable: false);
    st.addStr(customerName.name, isNullable: false);
    st.addStr(uniqShiftId.name, isNullable: false);
    st.addStr(placeName.name, isNullable: false);
    st.addStr(clientId.name, isNullable: false);
    st.addStr(senderId.name, isNullable: false);
    st.addStr(serveBy.name, isNullable: false);
    st.addBool(synchronize.name, isNullable: false);
    st.addBool(isReservation.name, isNullable: false);
    st.addBool(isAllFinish.name, isNullable: false);
