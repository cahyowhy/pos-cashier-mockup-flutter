...
abstract class _ShiftBean implements Bean<Shift> {
  ...
  Future<void> createTable({bool ifNotExists = false}) async {
    ...
    st.addDouble(actualBalance.name, isNullable: false);
    st.addDouble(systemBalance.name, isNullable: false);
    st.addDouble(differenceBalance.name, isNullable: false);
    st.addDouble(beginningBalance.name, isNullable: false);
    st.addDouble(cashCredit.name, isNullable: false);
    st.addDouble(cashDebit.name, isNullable: false);
    st.addDouble(cashOther.name, isNullable: false);
    st.addDouble(cashSales.name, isNullable: false);
    st.addDouble(cashback.name, isNullable: false);
    st.addInt(closeId.name, isNullable: false);
    st.addStr(closedBy.name, isNullable: false);
    st.addStr(openBy.name, isNullable: false);
    st.addStr(startingTime.name, isNullable: false);
    st.addStr(closingTime.name, isNullable: false);
    st.addInt(merchantId.name, isNullable: false);
    st.addStr(merchantName.name, isNullable: false);
    st.addInt(outletId.name, isNullable: false);
    st.addStr(outletName.name, isNullable: false);
    st.addInt(endDate.name, isNullable: false);
    st.addInt(startDate.name, isNullable: false);
    st.addInt(openId.name, isNullable: false);
    st.addInt(reject.name, isNullable: false);
    st.addInt(cancel.name, isNullable: false);
    st.addInt(sales.name, isNullable: false);
    st.addStr(uniqShiftId.name, primary: true, isNullable: false);
    st.addStr(deviceId.name, isNullable: false);
